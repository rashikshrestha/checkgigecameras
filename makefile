...
#
include $(IROOT)/examples/common/commondefs.mk
...
checkgigecameras : $(OBJS)
	$(CC) -g $(ARCH_LINK_OPTIONS) -o checkgigecameras $(OBJS) $(LCLLIBS) $(GENICAM_LIBS) -L$(ARCHLIBDIR) -lstdc++

clean:
	rm *.o checkgigecameras 
